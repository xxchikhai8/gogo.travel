...
class EnterpriseController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        return view('enterprise.dashboard', compact('revenue1', 'revenue2', 'revenue3', 'revenue4', 'revenue5', 'revenue6', 'revenue7', 'revenue8', 'revenue9', 'revenue10', 'revenue11', 'revenue12', 'select'));
    }
}
