    ...
    <div class="w-75 mx-auto">
        <form action="/update-plane/{{$plane->id}}" method="POST">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="flightID" class="form-control border border-dark" id="floatingInput" value="{{$plane->planeID}}"
                    placeholder="Plane ID">
                <label for="floatingInput">Plane ID</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="departure" class="form-control border border-dark" id="floatingInput" value="{{$plane->planeType}}"
